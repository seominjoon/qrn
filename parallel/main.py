...
from parallel.model import Tower, Runner
from config.get_config import get_config_from_file, get_config
from parallel.read_data import read_data

flags = tf.app.flags

# File directories
flags.DEFINE_string("model_name", "parallel", "Model name. This will be used for save, log, and eval names. [parallel]")
